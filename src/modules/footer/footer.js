...
const insertMainFooter = (footer) =>{
    footer.innerHTML = `
    <footer class="bg-footer text-dark pt-5 style="background-color:rgba(19, 219, 209, 0.25); color: white; padding: 30px; border-radius: 10px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2">
...
const insertMainFooter = (footer) =>{
    footer.innerHTML = `
    <footer class="bg-footer text-dark pt-5" style="background-color:#5FBAD3; color: white; padding: 30px; border-radius: 10px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.2);">
        <div class="container px-2">
            <div class="row">
                <div class="col-1">
                    <img src="../../../public/images/paws_footer.svg" alt="huellas de gatitos">
